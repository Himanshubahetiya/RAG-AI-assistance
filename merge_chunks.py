...
for filename in os.listdir("jsons"):
    if filename.endswith("json"):
        ...
        with open(file_path, "r", encoding="utf-8") as f:
            ...
            # save the file without .json
            os.makedirs("newjsons", exist_ok=True)
            with open(os.path.join("newjsons", filename),"w", encoding="utf-8") as jsons_file:
                json.dump({"chunks": new_chunks, "text": data['text']}, jsons_file  , indent=4)